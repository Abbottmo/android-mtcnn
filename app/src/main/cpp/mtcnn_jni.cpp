...
Java_com_abbott_mymtcnn_MTCNN_FaceDetectionModelInit(JNIEnv *env, jobject thiz,
...
Java_com_abbott_mymtcnn_MTCNN_FaceDetect(JNIEnv *env, jobject thiz, jbyteArray image_date,
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_com_abbott_mymtcnn_MTCNN_MaxFaceDetect(JNIEnv *env, jobject thiz, jbyteArray image_date,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_abbott_mymtcnn_MTCNN_FaceDetectionModelUnInit(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_abbott_mymtcnn_MTCNN_SetMinFaceSize(JNIEnv *env, jobject thiz, jint min_size) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_abbott_mymtcnn_MTCNN_SetThreadsNumber(JNIEnv *env, jobject thiz, jint threads_number) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_abbott_mymtcnn_MTCNN_SetTimeCount(JNIEnv *env, jobject thiz, jint time_count) {
